          ...
          <Form className='form'>  
              ...
              <Row align="middle" justify="space-between">
                <Col span={6}>
                  ...
                  className="contact"
                  >
                    <Select defaultValue="+91" onChange={handleChangePrefix} value={values.prefix} name={values.prefix}> 
                      {country_list.map(country => <Option value={country.dial_code} key={country.name}>{country.name} {country.dial_code}</Option>)}
                    </Select>
                  </Form.Item>
                </Col>
                <Col span={17}>
                  ...
                  >
                    <Input placeholder="Parent's Mobile" id="error2" type="number" value={values.contact} 
              ...
              <Row align="middle" >
                <Col span={24}>
                  <Form.Item>
                  <Button style={{width:'100%',height:'50px',background:values.contact.length===10 && values.class!=='' ? '#0FC543':'#FF7200',color:'white',fontSize:'20px'}}>
              ...
              <Form.Item>
                <span>By registering here, I agree to Whitehat Jr <a href="https://code-stage.whjr.one/terms-conditions" target="_blank">Terms & Conditions</a> and <a href="https://code-stage.whjr.one/privacy-policy" target="_blank">Privacy Policy</a></span>
              </Form.Item>
